package com.mahout.ApacheMahoutRecommender;
import java.io.File;
...
public class Recommender {
	public static void main(String[] args) {
		try {
			DataModel model = new FileDataModel(new File("C:\\MyFolder\\LibRecWorkSpace\\ApacheMahoutRecommender\\Data\\DataFile.txt"));
